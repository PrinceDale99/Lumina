...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      read_own_public_key: (...args_1) => {
        if (args_1.length !== 1)
          throw new __compactRuntime.CompactError(`read_own_public_key: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
        ...
        const result_0 = this.#_read_own_public_key_0(context, partialProofData);
                                                                              ...
                                                                              path: [
                                                                                     { tag: 'value',
                                                                                       value: { value: _descriptor_6.toValue(0n),
                                                                                                alignment: _descriptor_6.alignment() } }] } },
                                                                     { push: { storage: false,
                                                                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(disclosedPk_0),
                                                                                                                            alignment: _descriptor_0.alignment() }).encode() } },
                                                                     'member',
                                                                     { popeq: { cached: true,
                                                                                result: undefined } }]).value),
    ...
    return _descriptor_1.fromValue(Contract._query(context,
                                                   ...
                                                   [
                                                    ...
                                                    { idx: { cached: false,
                                                             ...
                                                             path: [
                                                                    { tag: 'value',
                                                                      value: { value: _descriptor_0.toValue(disclosedPk_0),
                                                                               alignment: _descriptor_0.alignment() } }] } },
                                                    { popeq: { cached: false,
                                                               result: undefined } }]).value);
  }
